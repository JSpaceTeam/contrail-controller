...
def parse_args(args_str):
    ...
    if args.conf_file:
        ...
        if 'disable_validation' in config.defaults():
            defaults['disable_validation'] = config.getboolean('DEFAULT', 'disable_validation')
        ...
        if 'enable_stats' in config.defaults():
            defaults['enable_stats'] = config.getboolean('DEFAULT', 'enable_stats')
    ...
    parser.add_argument(
        "--api_backdoor_port", type=int,
        help="Gevent api server backdoor port for debugging"
    )
    parser.add_argument(
        "--admin_port",
    ...
    parser.add_argument("--enable_stats", action='store_true', help="Enable Stats collection and printing")
